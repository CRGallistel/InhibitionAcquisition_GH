...
% right.
ExperimentID = 1004; % ID # for the experiment. This was assigned after data
...
%% Duration
r = strfind(raw,'End Date:')+10; % start of end date
mo = str2double(raw(r:r+1));
dy = str2double(raw(r+3:r+4));
yr = str2double(raw(r+6:r+7))+2000;
r = strfind(raw,'End Time:')+10; % start of end time
hr = str2double(raw(r:r+1));
mn = str2double(raw(r+3:r+4));
sc = str2double(raw(r+6:r+7));
